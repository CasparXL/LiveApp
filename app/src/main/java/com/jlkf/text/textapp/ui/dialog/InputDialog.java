...
public final class InputDialog {
    ...
    public static final class Builder
        ...
        public BaseDialog show() {
            ...
            mInputView.requestFocus();
            postDelayed(() -> mInputManager.showSoftInput(mInputView, 0), 500);
            dialog.addOnDismissListener(dialog1 -> {
        ...
        public void onClick(View v) {
            if (mInputView != null) {
                mInputView.clearFocus();
                InputMethodManager imm2 = (InputMethodManager) mInputView.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
                assert imm2 != null;
                imm2.hideSoftInputFromWindow(mInputView.getWindowToken(), InputMethodManager.RESULT_UNCHANGED_SHOWN);
